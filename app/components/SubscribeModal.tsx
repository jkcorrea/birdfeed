...
import { MAX_FREEIUM_TWEETS, TRIAL_DAYS, UPSELL_FEATURES } from '~/lib/constants'
    ...
    <FullscreenModal isOpen={mode !== null} onClose={onClose}>
      <div className="flex flex-col space-y-2 rounded-lg p-4 sm:space-y-4">
        ...
        <p className="sm:text-md mx-auto w-10/12 text-lg opacity-70">
          {`You're currently on the free plan, with a max of 3 transcripts and ${MAX_FREEIUM_TWEETS} tweets per transcript.`}
        </p>
