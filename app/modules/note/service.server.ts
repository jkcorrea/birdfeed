...
export async function createNote({ content, userId }: Pick<Note, 'content' | 'userId'>) {
  try {
...
export async function updateNote({ content, userId, id }: Pick<Note, 'content' | 'userId' | 'id'>) {
  try {
