    ...
    <div className="flex  flex-col items-center justify-center gap-y-10">
      {pending ? (
        <>
          ...
          <h3 className="text-3xl font-bold text-gray-900">Completing your checkout ...</h3>
          <p className="max-w-sm text-center font-semibold text-gray-700">This step can take a few seconds...</p>
        </>
      ) : (
        <>
